          ...
          <div class="tab-content" id="nav-tabContent">
            ...
            >
              ...
              <p>
                ...
                взаимодействия офиса с заказчиками и цехом. Для принятия заявок,
                контроля их выполнения, передачи работы в цех требовалось много
                ручной работы. Из-за чего страдали сроки, появлялось поле для
                ошибок.
              </p>
              <hr></hr>
              <h6 className="card-subtitle">Решение.</h6>
              <p>
                Логичным решением оказалось проработка и стандартизация рабочих
                процессов для дальнейшей автоматизации. Работа была разбита на
                следующие этапы:
                <li>
                ...
                Таким образом, офис приобретает статус консультатитвного органа,
                который отслеживает недоработки системы для их последующего
                решения в виде формализации процесса и его автоматизации. Данное
                решение позволило бы сократить срок выполнения заявок, убрать
                человеческий фактор, что положительно скажется на имидже
                компании и прибыли.
              </p>
            ...
            >
              ...
              <p>
                ...
                было желания пользоваться готовыми решениями. Решение: Банк
                Тинькофф выпустил API для связи с Тинькофф-Инвестициями, с
                помощью которой можно получить данные по счету, инструментам, а
                также открывать и закрывать заявки на куплю-продажу акций,
                облигаций и других финансовых инструментов. На начало работы
                была первая версия API, к которой можно было подключиться через
                SDK, используя Node.js.
              </p>
              <hr></hr>
              ...
              <li>
                Реализация получения котировок в реальном времени. Формировалась
                специальная очередь типа первый вошел - последний вышел. Сперва
                подгружались исторические данные котировок, а затем с помощью
                SDK подгружалась актуальная свеча. Когда свеча устаревала (т.к.
                они имеют временные рамки 1мин, 5мин, 30 мин и т.д.), то новая
                свеча добавлялась в очередь, а самая старая свеча из нее
                удалялась.
              </li>
              <li>
                Подсчет различных функций технического анализа. В специальный
                модуль подгружались данные из очереди, который выдавал
                результаты расчетов желаемых инструментов технического анализа.
              </li>
              <li>
              ...
              <p>
                Ввиду специфики API и ограниченного времени было принято решение
                приостановить проект, в ожидании API v2.0, которая бы решала все
                проблемы первой версии (самая главная проблема - отслеживание
                статуса заявок)
              </p>
              <hr></hr>
              <h6 className="card-subtitle">Используемые технологии:</h6>
              ...
              <p>
                Затем банк Тинькофф выпустил версию API v2.0, которая претерпела
                множество изменений. Было приянто решение сменить стек
                технологий.
              </p>
              <hr></hr>
              <h6 className="card-subtitle">
              ...
              <li>
                Для параметров стратегий был создан модуль оптимизации на основе
              ...
              <h6 className="card-subtitle">Используемые технологии:</h6>
              <p>
                Python, TinkoffAPI, numpy, pandas, tensorflow, keras, PyGAD, ta,
                matplotlib
              </p>
            </div>
            <div
            ...
            >
              ...
              <p>
                ...
                инструмент, заправить проволоку, а затем настроить около 15
                различных (часто связанных между собой) параметров, для
                получения диаметра и шага пружины.
              </p>
              <h6 className="card-subtitle">Решение:</h6>
            </div>
          </div>
